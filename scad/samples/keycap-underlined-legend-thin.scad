...
user_legend_text = "A";
user_legend_font_name = "M PLUS 1:style=Thin";
user_legend_underline_enabled = true;
// Derived from MPLUS1-Variable.ttf metrics plus the single-glyph resize scale used by legend_block().
user_legend_underline_width = 5.0;
user_legend_underline_thickness = 0.36510;
user_legend_underline_offset_y = -4.10060;
