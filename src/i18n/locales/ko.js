const ko = Object.freeze({
  ...
  panels: {
    ...
    export: {
      title: "내보내기",
      body: "3MF 인쇄 데이터와 나중에 편집을 다시 시작하기 위한 JSON을 저장할 수 있습니다.",
    },
  },
  exportPanel: {
  ...
  nameGroup: {
    title: "이름",
    description: "저장할 때 사용하는 이름입니다. 3MF와 편집 데이터 JSON 양쪽에 사용되며, 나중에 불러와도 이 이름이 유지됩니다.",
  },
  fieldGroup: {
    expand: "{title} 펼치기",
    collapse: "{title} 접기",
  ...
  fields: {
    name: {
      label: "이름",
      hint: "3MF와 편집 데이터 JSON의 저장 파일 이름으로 사용됩니다",
    },
    shapeProfile: {
      label: "기본 형상",
    ...
    keyWidth: {
      label: "폭",
      hint: "폭과 키 크기는 연동됩니다. 18 mm = 1u입니다.",
      secondaryLabel: "키 크기",
      miniLabel: "폭",
    },
    keyDepth: {
