const en = Object.freeze({
  ...
  dropOverlay: {
    title: "Drop a project / editor JSON",
    body: "Load a project directory, project ZIP, saved editor data, or a compatible JSON file.",
  },
  importReport: {
  ...
  project: {
    ...
    nameHint: "Used for the save directory and project manifest name",
    ...
    savedDirectory: "Saved project {name} to a directory",
    savedZip: "Directory save is not available, so project {name} was saved as a ZIP",
