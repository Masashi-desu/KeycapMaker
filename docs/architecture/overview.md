...
- J-STEM-LP01公式CADと派生OFFは公式配布物との同一性を確認済み。個別ライセンス名は未提示だが、公式配布、製品の性質、および機能追加告知に対するJezailFunder Japanの反応を根拠に掲載・再配布を継続する。異議申立て時の取り下げ方針を含む判断詳細は第三者ライセンス文書を参照する
